...
// constructs the path for a container given the 'runtime_dir' that
// was used as well as the container `containerId`. For example, given
// two containers, one with ID 'a9dd' and one nested within 'a9dd'
// with ID '4e3a' and with the flag 'runtime_dir' set to
// '/var/run/mesos' you would have a directory structure that looks
// like:
//
