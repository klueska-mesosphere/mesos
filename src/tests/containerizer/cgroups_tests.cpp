...
{
  Try<cgroups::devices::ListEntry> entry =
    cgroups::devices::ListEntry::parse("");
  EXPECT_ERROR(entry);

  entry = cgroups::devices::ListEntry::parse("x");
  EXPECT_ERROR(entry);

  entry = cgroups::devices::ListEntry::parse("b");
  EXPECT_ERROR(entry);

  entry = cgroups::devices::ListEntry::parse("b x");
  EXPECT_ERROR(entry);
  ...
  entry = cgroups::devices::ListEntry::parse("b *:* rwmx");
  EXPECT_ERROR(entry);

  entry = cgroups::devices::ListEntry::parse("b *:* rwm x");
  EXPECT_ERROR(entry);

  entry = cgroups::devices::ListEntry::parse("b x:x rwm");
  EXPECT_ERROR(entry);

  entry = cgroups::devices::ListEntry::parse("b *:x rwm");
  EXPECT_ERROR(entry);

  entry = cgroups::devices::ListEntry::parse("b x:* rwm");
  EXPECT_ERROR(entry);

  entry = cgroups::devices::ListEntry::parse("a");
  EXPECT_EQ("a *:* rwm", stringify(entry.get()));

  entry = cgroups::devices::ListEntry::parse("a x x");
  EXPECT_EQ("a *:* rwm", stringify(entry.get()));

  entry = cgroups::devices::ListEntry::parse("b *:* rwm");
  EXPECT_EQ("b *:* rwm", stringify(entry.get()));

  entry = cgroups::devices::ListEntry::parse("b *:* r");
  EXPECT_EQ("b *:* r", stringify(entry.get()));

  entry = cgroups::devices::ListEntry::parse("b *:* w");
  EXPECT_EQ("b *:* w", stringify(entry.get()));

  entry = cgroups::devices::ListEntry::parse("b *:* m");
  EXPECT_EQ("b *:* m", stringify(entry.get()));

  entry = cgroups::devices::ListEntry::parse("b 1:* rwm");
  EXPECT_EQ("b 1:* rwm", stringify(entry.get()));

  entry = cgroups::devices::ListEntry::parse("b *:3 rwm");
  EXPECT_EQ("b *:3 rwm", stringify(entry.get()));

  entry = cgroups::devices::ListEntry::parse("b 1:3 rwm");
...
TEST_F(CgroupsAnyHierarchyDevicesTest, ROOT_CGROUPS_Devices)
{
  ...
  Try<cgroups::devices::ListEntry> entry =
    cgroups::devices::ListEntry::parse("a *:* rwm");
  ...
  Try<vector<cgroups::devices::ListEntry>> whitelist =
  ...
  entry = cgroups::devices::ListEntry::parse("c 1:3 rwm");
