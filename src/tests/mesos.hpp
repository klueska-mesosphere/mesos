...
protected:
  ...
  virtual process::Owned<cluster::Master> StartMaster(
  ...
  virtual process::Owned<cluster::Slave> StartSlave(
  ...
  // Starts a slave with the specified detector, resource estimator,
  ...
  // Starts a slave with the specified detector, QoS Controller,
  // containerizer, and flags.
  virtual process::Owned<cluster::Slave> StartSlave(
      MasterDetector* detector,
      slave::Containerizer* containerizer,
